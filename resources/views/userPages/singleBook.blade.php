    ...
    <div class="row">
        <form id="review-form" method="Post">
            ...
            <div class=" form-group">
                ...
                <input type="hidden" value="{{ auth()->user()->lastname }}" id="reviewLastname" name="reviewLastname">
                <textarea class="form-control" name="reviewArea" id="reviewArea" rows="3" placeholder="Napíš recenziu.."
                    required></textarea>
            </div>
